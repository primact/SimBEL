...
setClass(
    Class = "ParamComport",
    slots = c(
        mat_oblig = "numeric", alloc_mar = "numeric", w_n = "numeric",
    ...
    validity = function(object) {
        ...
        if (object@mat_oblig < 0 | round(object@mat_oblig) != object@mat_oblig) {
            retval <- c(retval, "[ParamComport] :  maturite doit etre un entier strictement positif. \n")
        }
