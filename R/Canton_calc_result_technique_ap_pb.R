#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# Ce script comprend la fonction permettant de calculer le resultat technique apres PB
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
##'
##' \code{calc_result_technique_ap_pb} est une methode permettant de calculer le resultat technique apres attribution de
...
##' @param passif_ap_pb est une liste produit par la methode \code{viellissement_ap_pb}.
...
setMethod(
  ...
  definition = function(passif_av_pb, passif_ap_pb, ppb, var_pre){
    ...
    result_tech <-  passif_av_pb[["flux_milieu"]] +
      ...
      sum(passif_ap_pb[["stock_agg"]][, "pm_fin_ap_pb"][[1]] - # Variation PM  sur les produits inclus dans le modele
