...
setGeneric(name = "chargement_PortFin", function(folder_PortFin_address, mp_ESG) {
    standardGeneric("chargement_PortFin")
})
setMethod(
    ...
    definition = function(folder_PortFin_address, mp_ESG) {
        ...
        file_name <- read.csv2(paste(folder_PortFin_address, "/noms_fichiers.csv", sep = ""),
            header = TRUE,
