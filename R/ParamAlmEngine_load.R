...
##' \code{\link{chargement_PortFin_reference}}.
...
setGeneric(name = "param_alm_engine_load", def = function(file_alm_address, ptf_fin_ref) {
    standardGeneric("param_alm_engine_load")
})
setMethod(
