...
setValidity ("Action",
             function (object){
                 ...
                 if(ncol(ptf_action) != 12L) retval <- c(retval, "[Action] : Nombre d'attributs incorrect, un ptf Action est compose d'un DF de 12 colonnes /n")
                 ...
                 if(sum(colnames(object@ptf_action)==c("num_mp","val_marche","val_nc","val_achat",
                                                       ...
                                                       "pdd","num_index","div","ind_invest")) != 12L)
...
setMethod(
    ...
    definition = function(.Object, ptf=data.frame()){
        ...
        if( !missing(ptf)){
            ...
            if(ncol(ptf) != 12L | sum(names(ptf)!=c("num_mp","val_marche","val_nc","val_achat",
                                                    "presence","cessible","nb_unit","dur_det",
                                                    "pdd","num_index","div","ind_invest")) != 0L) {
