...
##'
##' \code{do_choc_longevite} est une methode permettant d'appliquer le choc longevite de la formule standard Solvabilite 2 a un canton.
...
##' @return \code{canton} l'objet  de la classe \code{canton} correspondant au scenario choque longevite au sens de la formule standard Solvabilite 2.
