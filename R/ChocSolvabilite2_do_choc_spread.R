...
##'
##' \code{do_choc_spread} est une methode permettant d'appliquer le choc spread de la formule standard Solvabilite 2 a un canton.
##' @name do_choc_spread
##' @docType methods
...
##' @return \code{canton} l'objet  de la classe \code{canton} correspondant au scenario choque spread au sens de la formule standard Solvabilite 2.
##' @note Il est possible d'appliquer des chocs de spreads distincts a chaque ligne du portefeuille obligataire selon l'index de la ligne obligataire.
