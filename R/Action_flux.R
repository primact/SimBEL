...
##' @name revalo_action
##' @docType methods
##' @param x objet de la classe Action (decrivant le portefeuille d'action).
##' @param S vecteur de valeur de chaque stock du ptf en milieu d'annee N (date de versement des dividendes)
##' @param S_prev vecteur de valeur de chaque stock du ptf en milieu d'annee N-1.
