...
##' @docType methods
##' @param file_reteurorest_address est un \code{character} contenant l'adresse exacte du fichier d'input utilisateur permettant de renseigner
##' le portefeuille.
...
setGeneric(name = "load_reteurorest", def = function(file_reteurorest_address) {
    standardGeneric("load_reteurorest")
})
setMethod(
    f = "load_reteurorest",
    signature = "character",
