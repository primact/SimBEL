...
##' @return \code{canton} l'objet  de la classe \code{canton} correspondant au scenario de choc a la baisse des taux de rachats au sens de la formule standard Solvabilite 2.
##' @note La parametrisation des chocs a la baisse des taux de rachat est effectuee dans les fichiers d'inputs utilisateurs. 
##' @author Prim'Act
##' @export
