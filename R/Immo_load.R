...
##' @name load_immo
##' @docType methods
##' @param file_immo_address est un \code{character} contenant l'adresse exacte du fichier d'input utilisateur permettant de renseigner le portefeuille.
...
setGeneric(name = "load_immo", def = function(file_immo_address){standardGeneric("load_immo")})
setMethod(
    f = "load_immo",
    signature = "character",
    definition = function(file_immo_address){
        ...
        # Lecture du fichier
        temp <- read.csv2(file_immo_address, colClasses = c("integer","numeric","numeric","numeric","logical",
