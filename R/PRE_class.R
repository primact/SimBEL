...
##' @docType class
##' @author Prim'Act
##' @seealso Les methodes de calcul de la PRE \code{\link{calc_PRE}}, et de mises a jour des PRE initiales et courantes
##' \code{\link{do_update_PRE_val_courante}}, \code{\link{do_update_PRE_val_debut}}.
##' @keywords classes
##' @export
...
setValidity(
    ...
    function(object) {
        ...
        if (length(object@ryth_dot) > 0L) {
            if (object@ryth_dot < 3 | object@ryth_dot > 8) {
