...
##' @name load_epeuroind
##' @docType methods
##' @param file_epeuroind_address est un \code{character} contenant l'adresse exacte du fichier d'input utilisateur permettant de renseigner le portefeuille.
...
setGeneric(name = "load_epeuroind", def = function(file_epeuroind_address){standardGeneric("load_epeuroind")})
setMethod(
    f = "load_epeuroind",
    signature = "character",
