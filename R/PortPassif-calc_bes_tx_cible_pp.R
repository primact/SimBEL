...
# 
# #----------------------------------------------------------------------------------------------------------------------------------------------------
# #           Fonction de calcul du besoin de taux cible pour le portefeuille
# #----------------------------------------------------------------------------------------------------------------------------------------------------
# ##' Calcul les PM d'un model point epargne en euros.
# ##'
# ##' \code{calc_bes_tx_cible_pp} est une methode permettant de calculer le besoin de taux cible pour le portefeuille
# ##' @name calc_bes_tx_cible_pp
# ##' @docType methods
...
# ##' @aliases PortPassif
# ##'
# setGeneric(name = "calc_bes_tx_cible_pp", def = function(x, tab_prime_pp, tab_prest_pp, tab_pm_pp)
#           {standardGeneric("calc_bes_tx_cible_pp")})
# #--------------------------------------------------------
# 
# setMethod(
#   f = "calc_bes_tx_cible_pp",
#   signature = c(x = "PortPassif", tab_prime_pp = "list", tab_prest_pp = "list", tab_pm_pp = "list"),
#   def = function(x, tab_prime_pp, tab_prest_pp, tab_pm_pp){
#     
#     
#     list_bes_tx_cible_det <- NULL
#     list_bes_tx_cible_agg <- NULL
#     bes_tx_cible_tot <- NULL
...
#         list_bes_tx_cible_det[[i+j-1]] <- calc_bes_tx_cible(mpij,tx_cible_mp,tab_prime_pp$list_primes_det[[i+j-1]],
#                                           tab_prest_pp$list_prest_det[[i+j-1]]$flux, tab_pm_pp$list_pm_det[[i+j-1]])
#         list_bes_tx_cible_agg[[i+j-1]] <- colSums(list_bes_tx_cible_det[[i+j-1]])
#         
#         if (i == 1 & j == 1) {
#           bes_tx_cible_tot <- colSums(list_bes_tx_cible_det[[i+j-1]])
#         }
#         else {
#           bes_tx_cible_tot <- bes_tx_cible_tot + colSums(list_bes_tx_cible_det[[i+j-1]])
#         }  
#         
#         names(list_bes_tx_cible_det)[i+j-1] <- names(x[ncpi])[j]
#         names(list_bes_tx_cible_agg)[i+j-1] <- names(x[ncpi])[j]
#       }
#     }
#     
#     
#     # output
#     return(list(list_bes_tx_cible_det = list_bes_tx_cible_det, list_bes_tx_cible_agg = list_bes_tx_cible_agg, bes_tx_cible_tot = bes_tx_cible_tot))
#     
#   }
# )
