...
##'
##' \code{update_cc_oblig} est une methode permettant de mettre a jour les coupons courus des composantes d'un portefeuille obligataire.
##' @name update_cc_oblig
##' @docType methods
##' @param x objet de la classe \code{Oblig} (decrivant le portefeuille obligataire en detention).
##' @param coupon un vecteur de \code{numeric} a assigner a l'objet \code{Obligation}. 
