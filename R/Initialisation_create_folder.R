...
##'
##' \code{init_create_folder} est une methode permettant de creer l'architecture de sauvegarde des scenarios et executions du code a partir de la racine renseignee.
...
##'  creer un objet \code{\link{Initialisation}} en lui ayant affecte une racine,
