...
#           update_zsp_oblig
#----------------------------------------------------------------------------------------------------------------------------------------------------
##' Mise a jour des zspreads d'un portefeuille obligataire.
##'
##' \code{update_zsp_oblig} est une methode permettant de mettre a jour les zspreads des composantes d'un portefeuille obligataire.
