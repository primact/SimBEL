...
##' @param montant_vente est un reel de type \code{numeric} correspondant a un montant de vente (en valeur de marche) totale d'action que l'assureur
##' souhaite effectuer.
...
setGeneric(name = "do_calc_nb_sold_action", def = function(x, montant_vente, method_vente) {
    standardGeneric("do_calc_nb_sold_action")
})
setMethod(
