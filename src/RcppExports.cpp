...
static const R_CallMethodDef CallEntries[] = {
    {"SimBEL_echeancier", (DL_FUNC) &SimBEL_echeancier, 5},
    {"SimBEL_calc_tx_cible_ref_marche", (DL_FUNC) &SimBEL_calc_tx_cible_ref_marche, 6},
    {"SimBEL_calc_rach_dyn", (DL_FUNC) &SimBEL_calc_rach_dyn, 3},
    {NULL, NULL, 0}
};
