...
table_mort_tgf05 <- read.csv2(paste(path, "input/parametres/tables/TGF05_lx.csv", sep = "/"), header = TRUE, colClasses = c("integer", "integer", "numeric"))
table_mort_expF <- read.csv2(paste(path, "input/parametres/tables/Table_Exp_F.csv", sep = "/"), header = TRUE, colClasses = c("integer", "integer", "numeric"))
table_mort_expH <- read.csv2(paste(path, "input/parametres/tables/Table_Exp_H.csv", sep = "/"), header = TRUE, colClasses = c("integer", "integer", "numeric"))
...
test_that("TEST_choc_longevite", {
    ...
    expect_equal(hypt@tables_mort$TM2@table$qx[rang_test], (table_mort_expF$valeur[rang_test]-table_mort_expF$valeur[rang_test+1])/table_mort_expF$valeur[rang_test])
    expect_equal(hypt@tables_mort$TM1@table$qx[rang_test], (table_mort_expH$valeur[rang_test]-table_mort_expH$valeur[rang_test+1])/table_mort_expH$valeur[rang_test])
    expect_equal(hypt@tables_mort$TM2@table$qx[120], (table_mort_expF$valeur[120]-table_mort_expF$valeur[121])/table_mort_expF$valeur[120])
    expect_equal(hypt@tables_mort$TM1@table$qx[120], (table_mort_expH$valeur[120]-table_mort_expH$valeur[121])/table_mort_expH$valeur[120])
    ...
    expect_equal(tables_choc@tables_mort$TM1@table[2, "lx"], tables_choc@tables_mort$TM1@table[1, "lx"]*(1-tables_choc@tables_mort$TM1@table[1, "qx"]))
    expect_equal(tables_choc@tables_mort$TM2@table[2, "lx"], tables_choc@tables_mort$TM2@table[1, "lx"]*(1-tables_choc@tables_mort$TM2@table[1, "qx"]))
    expect_equal(tables_choc@tables_mort$test@table[2, "lx"], tables_choc@tables_mort$test@table[1, "lx"]*(1-tables_choc@tables_mort$test@table[1, "qx"]))
    expect_equal(tables_choc@tables_mort$TM1@table[rang_test, "lx"], tables_choc@tables_mort$TM1@table[rang_test-1, "lx"]*(1-tables_choc@tables_mort$TM1@table[rang_test-1, "qx"]))
    expect_equal(tables_choc@tables_mort$TM2@table[rang_test, "lx"], tables_choc@tables_mort$TM2@table[rang_test-1, "lx"]*(1-tables_choc@tables_mort$TM2@table[rang_test-1, "qx"]))
    expect_equal(tables_choc@tables_mort$test@table[rang_test, "lx"], tables_choc@tables_mort$test@table[rang_test-1, "lx"]*(1-tables_choc@tables_mort$test@table[rang_test-1, "qx"]))
