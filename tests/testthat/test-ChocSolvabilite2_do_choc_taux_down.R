...
courbe_taux_down0 <- read.csv2(paste(path, "input/parametres/esg/ESG_down/Simulation_CourbeDesTaux/Courbe_Taux_dans_0_an_G2++_20160510_14h32m00s_QZCsto _.csv", sep = "/"))
courbe_taux_down1 <- read.csv2(paste(path, "input/parametres/esg/ESG_down/Simulation_CourbeDesTaux/Courbe_Taux_dans_1_an_G2++_20160510_14h32m00s_QZCsto _.csv", sep = "/"))
courbe_taux_down2 <- read.csv2(paste(path, "input/parametres/esg/ESG_down/Simulation_CourbeDesTaux/Courbe_Taux_dans_2_an_G2++_20160510_14h32m00s_QZCsto _.csv", sep = "/"))
courbe_taux_down3 <- read.csv2(paste(path, "input/parametres/esg/ESG_down/Simulation_CourbeDesTaux/Courbe_Taux_dans_3_an_G2++_20160510_14h32m00s_QZCsto _.csv", sep = "/"))
courbe_taux_down4 <- read.csv2(paste(path, "input/parametres/esg/ESG_down/Simulation_CourbeDesTaux/Courbe_Taux_dans_4_an_G2++_20160510_14h32m00s_QZCsto _.csv", sep = "/"))
courbe_taux_down5 <- read.csv2(paste(path, "input/parametres/esg/ESG_down/Simulation_CourbeDesTaux/Courbe_Taux_dans_5_an_G2++_20160510_14h32m00s_QZCsto _.csv", sep = "/"))
courbe_taux_down6 <- read.csv2(paste(path, "input/parametres/esg/ESG_down/Simulation_CourbeDesTaux/Courbe_Taux_dans_6_an_G2++_20160510_14h32m00s_QZCsto _.csv", sep = "/"))
courbe_taux_down7 <- read.csv2(paste(path, "input/parametres/esg/ESG_down/Simulation_CourbeDesTaux/Courbe_Taux_dans_7_an_G2++_20160510_14h32m00s_QZCsto _.csv", sep = "/"))
courbe_taux_down8 <- read.csv2(paste(path, "input/parametres/esg/ESG_down/Simulation_CourbeDesTaux/Courbe_Taux_dans_8_an_G2++_20160510_14h32m00s_QZCsto _.csv", sep = "/"))
courbe_taux_down9 <- read.csv2(paste(path, "input/parametres/esg/ESG_down/Simulation_CourbeDesTaux/Courbe_Taux_dans_9_an_G2++_20160510_14h32m00s_QZCsto _.csv", sep = "/"))
courbe_taux_down10 <- read.csv2(paste(path, "input/parametres/esg/ESG_down/Simulation_CourbeDesTaux/Courbe_Taux_dans_10_an_G2++_20160510_14h32m00s_QZCsto _.csv", sep = "/"))
