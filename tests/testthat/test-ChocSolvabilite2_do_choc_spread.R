...
table_choc_spread_csv <- read.csv2(paste(path, "input/parametres/chocs/param_choc_mket_spread.csv", sep = "/"), colClasses = c("integer", "character", "numeric", "numeric"))
ptf_obligation_csv <- read.csv2(paste(path, "input/donnees/actif/Portefeuille_obligation.csv", sep = "/"), colClasses = c(
