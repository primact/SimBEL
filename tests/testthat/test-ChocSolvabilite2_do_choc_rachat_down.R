...
test_that("TEST_choc_rachat_down", {
    ...
    expect_equal(tables_choc_down@ tables_rach$TRP1@table$taux_rachat, pmax(hypt@tables_rach$TRP1@table$taux_rachat*(1+choc_rachat_down),hypt@tables_rach$TRP1@table$taux_rachat + choc_rachat_down_lim))
  })
