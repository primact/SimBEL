...
central@base <- new("DataBase", file_adress = paste(racine@root_address, "internal_ws/data/database", sep = "/"), ecriture_base = FALSE, choc_name = "central")
...
rachat_mass@base <- new("DataBase", file_adress = paste(racine@root_address, "internal_ws/data/database", sep = "/"), ecriture_base = FALSE, choc_name = "rachat_mass")
BE_rachat_mass_result <- run_be(rachat_mass,F,F)
