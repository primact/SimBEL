...
courbe_taux_up0 <- read.csv2(
    paste(path, "input/parametres/esg/ESG_up/Simulation_CourbeDesTaux/Courbe_Taux_dans_0_an_G2++_20160510_14h28m31s_QZCsto _.csv", sep = "/")
)
courbe_taux_up1 <- read.csv2(
    paste(path, "input/parametres/esg/ESG_up/Simulation_CourbeDesTaux/Courbe_Taux_dans_1_an_G2++_20160510_14h28m31s_QZCsto _.csv", sep = "/")
)
courbe_taux_up2 <- read.csv2(
    paste(path, "input/parametres/esg/ESG_up/Simulation_CourbeDesTaux/Courbe_Taux_dans_2_an_G2++_20160510_14h28m31s_QZCsto _.csv", sep = "/")
)
courbe_taux_up3 <- read.csv2(
    paste(path, "input/parametres/esg/ESG_up/Simulation_CourbeDesTaux/Courbe_Taux_dans_3_an_G2++_20160510_14h28m31s_QZCsto _.csv", sep = "/")
)
courbe_taux_up4 <- read.csv2(
    paste(path, "input/parametres/esg/ESG_up/Simulation_CourbeDesTaux/Courbe_Taux_dans_4_an_G2++_20160510_14h28m31s_QZCsto _.csv", sep = "/")
)
courbe_taux_up5 <- read.csv2(
    paste(path, "input/parametres/esg/ESG_up/Simulation_CourbeDesTaux/Courbe_Taux_dans_5_an_G2++_20160510_14h28m31s_QZCsto _.csv", sep = "/")
)
courbe_taux_up6 <- read.csv2(
    paste(path, "input/parametres/esg/ESG_up/Simulation_CourbeDesTaux/Courbe_Taux_dans_6_an_G2++_20160510_14h28m31s_QZCsto _.csv", sep = "/")
)
courbe_taux_up7 <- read.csv2(
    paste(path, "input/parametres/esg/ESG_up/Simulation_CourbeDesTaux/Courbe_Taux_dans_7_an_G2++_20160510_14h28m31s_QZCsto _.csv", sep = "/")
)
courbe_taux_up8 <- read.csv2(
    paste(path, "input/parametres/esg/ESG_up/Simulation_CourbeDesTaux/Courbe_Taux_dans_8_an_G2++_20160510_14h28m31s_QZCsto _.csv", sep = "/")
)
courbe_taux_up9 <- read.csv2(
    paste(path, "input/parametres/esg/ESG_up/Simulation_CourbeDesTaux/Courbe_Taux_dans_9_an_G2++_20160510_14h28m31s_QZCsto _.csv", sep = "/")
)
courbe_taux_up10 <- read.csv2(
    paste(path, "input/parametres/esg/ESG_up/Simulation_CourbeDesTaux/Courbe_Taux_dans_10_an_G2++_20160510_14h28m31s_QZCsto _.csv", sep = "/")
)
